...
VIRES_ORBIT_COUNTER_A_DST = join(PROJECT_DIR, "SW_OPER_AUXAORBCNT.cdf")
VIRES_ORBIT_COUNTER_B_DST = join(PROJECT_DIR, "SW_OPER_AUXBORBCNT.cdf")
VIRES_ORBIT_COUNTER_C_DST = join(PROJECT_DIR, "SW_OPER_AUXCORBCNT.cdf")
