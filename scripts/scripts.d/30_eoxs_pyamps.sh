...
# temporary fix of PyAMPS v1.6.0 - to be removed when PyAMPS >= v1.6.1 is released
pip install $PIP_OPTIONS git+https://github.com/pacesm/pyAMPS.git@1.6_fixed#pyamps
